...
func (_m *Frontend) Create(ctx context.Context, definition frontend.Definition) (v1.Frontend, error) {
	...
	var r0 v1.Frontend
	if rf, ok := ret.Get(0).(func(context.Context, frontend.Definition) v1.Frontend); ok {
		r0 = rf(ctx, definition)
	} else {
		r0 = ret.Get(0).(v1.Frontend)
	}
...
func (_m *Frontend) GetByID(ctx context.Context, identifier string) (v1.Frontend, error) {
	...
	var r0 v1.Frontend
	if rf, ok := ret.Get(0).(func(context.Context, string) v1.Frontend); ok {
		r0 = rf(ctx, identifier)
	} else {
		r0 = ret.Get(0).(v1.Frontend)
	}
...
func (_m *Frontend) Update(ctx context.Context, identifier string, definition frontend.Definition) (v1.Frontend, error) {
	...
	var r0 v1.Frontend
	if rf, ok := ret.Get(0).(func(context.Context, string, frontend.Definition) v1.Frontend); ok {
