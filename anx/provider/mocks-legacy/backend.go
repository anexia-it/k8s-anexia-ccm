...
func (_m *Backend) Create(ctx context.Context, definition backend.Definition) (v1.Backend, error) {
	...
	var r0 v1.Backend
	if rf, ok := ret.Get(0).(func(context.Context, backend.Definition) v1.Backend); ok {
		r0 = rf(ctx, definition)
	} else {
		r0 = ret.Get(0).(v1.Backend)
	}
...
func (_m *Backend) GetByID(ctx context.Context, identifier string) (v1.Backend, error) {
	...
	var r0 v1.Backend
	if rf, ok := ret.Get(0).(func(context.Context, string) v1.Backend); ok {
		r0 = rf(ctx, identifier)
	} else {
		r0 = ret.Get(0).(v1.Backend)
	}
...
func (_m *Backend) Update(ctx context.Context, identifier string, definition backend.Definition) (v1.Backend, error) {
	...
	var r0 v1.Backend
	if rf, ok := ret.Get(0).(func(context.Context, string, backend.Definition) v1.Backend); ok {
